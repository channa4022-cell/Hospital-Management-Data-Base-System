...
📄 Project Structure
Hospital-Management-System │ ├── Database │ ├── create_tables.sql │ ├── insert_data.sql │ ├── queries.sql │ ├── Stored Procedures.sql │ └── Triggers.sql │ ├── ER_Diagram │ └── hospital_er_diagram.png │ └── README.md
